...
## Requirements
- Python 3.10
- Libraries: numpy, matplotlib, collections (deque)
...
- Setpoints are approximated from the paper figures:
  - Fig. 7: Step response on wheel speeds (used ~[15,15,15] rad/s for demo; paper shows ~[40,40,-50]).
  - Fig. 9: Step in vehicle velocity (used [0.5,0.5,2.0] m/s & rad/s).
